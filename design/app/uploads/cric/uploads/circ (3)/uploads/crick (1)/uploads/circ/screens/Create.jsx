  ...
  return (
    <div className="ck-screen" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--ink)', color: 'var(--paper)' }}>
      ...
      <div style={{ padding: '12px 20px 22px', display: 'flex', flexDirection: 'column', gap: 8 }}>
        <button onClick={reset} style={{ width: '100%', padding: 14, borderRadius: 12, border: 'none', background: 'var(--paper)', color: 'var(--ink)', fontWeight: 600, fontSize: 14, fontFamily: 'inherit', cursor: 'pointer' }}>Open tournament</button>
