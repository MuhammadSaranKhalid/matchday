...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,matchId,teamAId,teamBId,teamACaptain,teamBCaptain,const DeepCollectionEquality().hash(format),venue,scheduledStartTime,actualStartTime,const DeepCollectionEquality().hash(result),status,tossWonBy,tossDecision,tossFace,startPhase,openersSubmittedBy,openersSubmittedAt,createdBy,createdAt]);

@override
String toString() {
  return 'MatchDto(matchId: $matchId, teamAId: $teamAId, teamBId: $teamBId, teamACaptain: $teamACaptain, teamBCaptain: $teamBCaptain, format: $format, venue: $venue, scheduledStartTime: $scheduledStartTime, actualStartTime: $actualStartTime, result: $result, status: $status, tossWonBy: $tossWonBy, tossDecision: $tossDecision, tossFace: $tossFace, startPhase: $startPhase, openersSubmittedBy: $openersSubmittedBy, openersSubmittedAt: $openersSubmittedAt, createdBy: $createdBy, createdAt: $createdAt)';
}
...
/// Create a copy of MatchDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? matchId = null,Object? teamAId = null,Object? teamBId = null,Object? teamACaptain = freezed,Object? teamBCaptain = freezed,Object? format = null,Object? venue = freezed,Object? scheduledStartTime = freezed,Object? actualStartTime = freezed,Object? result = freezed,Object? status = null,Object? tossWonBy = freezed,Object? tossDecision = freezed,Object? tossFace = freezed,Object? startPhase = null,Object? openersSubmittedBy = freezed,Object? openersSubmittedAt = freezed,Object? createdBy = freezed,Object? createdAt = null,}) {
...
switch (_that) {
case _MatchDto() when $default != null:
return $default(_that.matchId,_that.teamAId,_that.teamBId,_that.teamACaptain,_that.teamBCaptain,_that.format,_that.venue,_that.scheduledStartTime,_that.actualStartTime,_that.result,_that.status,_that.tossWonBy,_that.tossDecision,_that.tossFace,_that.startPhase,_that.openersSubmittedBy,_that.openersSubmittedAt,_that.createdBy,_that.createdAt);case _:
  return orElse();
