...
switch (_that) {
case _MatchDto() when $default != null:
return $default(_that.matchId,_that.teamAId,_that.teamBId,_that.teamACaptain,_that.teamBCaptain,_that.setupTeamId,_that.format,_that.venue,_that.scheduledStartTime,_that.actualStartTime,_that.result,_that.status,_that.matchType,_that.tossWonBy,_that.tossDecision,_that.tossFace,_that.tossRecordedBy,_that.startPhase,_that.openersSubmittedBy,_that.openersSubmittedAt,_that.createdBy,_that.createdAt);case _:
  return orElse();
