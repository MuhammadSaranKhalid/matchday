...
/// Create a copy of MatchRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? requestId = null,Object? fromTeamId = null,Object? toTeamId = freezed,Object? requestedBy = null,Object? proposedStartTime = freezed,Object? proposedVenue = freezed,Object? proposedFormatCode = freezed,Object? proposedFormat = freezed,Object? message = freezed,Object? playersPerSide = null,Object? fromTeamXi = null,Object? fromTeamKeeperId = freezed,Object? counteredStartTime = freezed,Object? counteredVenue = freezed,Object? counteredFormatCode = freezed,Object? counteredFormat = freezed,Object? counteredPlayersPerSide = freezed,Object? status = null,Object? decidedBy = freezed,Object? decidedAt = freezed,Object? decisionNote = freezed,Object? decisionReason = freezed,Object? matchId = freezed,Object? shareCode = freezed,Object? codeExpiresAt = freezed,Object? proposalExpiresAt = freezed,Object? counterExpiresAt = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as String?,proposedFormatCode: freezed == proposedFormatCode ? _self.proposedFormatCode : proposedFormatCode // ignore: cast_nullable_to_non_nullable
...
as String?,counteredFormatCode: freezed == counteredFormatCode ? _self.counteredFormatCode : counteredFormatCode // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _MatchRequestDto() when $default != null:
return $default(_that.requestId,_that.fromTeamId,_that.toTeamId,_that.requestedBy,_that.proposedStartTime,_that.proposedVenue,_that.proposedFormatCode,_that.proposedFormat,_that.message,_that.playersPerSide,_that.fromTeamXi,_that.fromTeamKeeperId,_that.counteredStartTime,_that.counteredVenue,_that.counteredFormatCode,_that.counteredFormat,_that.counteredPlayersPerSide,_that.status,_that.decidedBy,_that.decidedAt,_that.decisionNote,_that.decisionReason,_that.matchId,_that.shareCode,_that.codeExpiresAt,_that.proposalExpiresAt,_that.counterExpiresAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@override@JsonKey(name: 'proposed_format_code') final  String? proposedFormatCode;
...
@override@JsonKey(name: 'countered_format_code') final  String? counteredFormatCode;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MatchRequestDto&&(identical(other.requestId, requestId) || other.requestId == requestId)&&(identical(other.fromTeamId, fromTeamId) || other.fromTeamId == fromTeamId)&&(identical(other.toTeamId, toTeamId) || other.toTeamId == toTeamId)&&(identical(other.requestedBy, requestedBy) || other.requestedBy == requestedBy)&&(identical(other.proposedStartTime, proposedStartTime) || other.proposedStartTime == proposedStartTime)&&(identical(other.proposedVenue, proposedVenue) || other.proposedVenue == proposedVenue)&&(identical(other.proposedFormatCode, proposedFormatCode) || other.proposedFormatCode == proposedFormatCode)&&const DeepCollectionEquality().equals(other._proposedFormat, _proposedFormat)&&(identical(other.message, message) || other.message == message)&&(identical(other.playersPerSide, playersPerSide) || other.playersPerSide == playersPerSide)&&const DeepCollectionEquality().equals(other._fromTeamXi, _fromTeamXi)&&(identical(other.fromTeamKeeperId, fromTeamKeeperId) || other.fromTeamKeeperId == fromTeamKeeperId)&&(identical(other.counteredStartTime, counteredStartTime) || other.counteredStartTime == counteredStartTime)&&(identical(other.counteredVenue, counteredVenue) || other.counteredVenue == counteredVenue)&&(identical(other.counteredFormatCode, counteredFormatCode) || other.counteredFormatCode == counteredFormatCode)&&const DeepCollectionEquality().equals(other._counteredFormat, _counteredFormat)&&(identical(other.counteredPlayersPerSide, counteredPlayersPerSide) || other.counteredPlayersPerSide == counteredPlayersPerSide)&&(identical(other.status, status) || other.status == status)&&(identical(other.decidedBy, decidedBy) || other.decidedBy == decidedBy)&&(identical(other.decidedAt, decidedAt) || other.decidedAt == decidedAt)&&(identical(other.decisionNote, decisionNote) || other.decisionNote == decisionNote)&&(identical(other.decisionReason, decisionReason) || other.decisionReason == decisionReason)&&(identical(other.matchId, matchId) || other.matchId == matchId)&&(identical(other.shareCode, shareCode) || other.shareCode == shareCode)&&(identical(other.codeExpiresAt, codeExpiresAt) || other.codeExpiresAt == codeExpiresAt)&&(identical(other.proposalExpiresAt, proposalExpiresAt) || other.proposalExpiresAt == proposalExpiresAt)&&(identical(other.counterExpiresAt, counterExpiresAt) || other.counterExpiresAt == counterExpiresAt)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,requestId,fromTeamId,toTeamId,requestedBy,proposedStartTime,proposedVenue,proposedFormatCode,const DeepCollectionEquality().hash(_proposedFormat),message,playersPerSide,const DeepCollectionEquality().hash(_fromTeamXi),fromTeamKeeperId,counteredStartTime,counteredVenue,counteredFormatCode,const DeepCollectionEquality().hash(_counteredFormat),counteredPlayersPerSide,status,decidedBy,decidedAt,decisionNote,decisionReason,matchId,shareCode,codeExpiresAt,proposalExpiresAt,counterExpiresAt,createdAt,updatedAt]);
