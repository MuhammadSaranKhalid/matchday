                ...
                for (final (i, w) in card.fallOfWickets.indexed)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border: i == card.fallOfWickets.length - 1
                          ? null
                          : const Border(
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          ...
          children: [
            ...
            CmFigureCell('${line.balls}',
                width: 26, size: 11, weight: FontWeight.w600,
                color: CkColors.ink2),
            CmFigureCell('${line.fours}',
                width: 20, size: 11, weight: FontWeight.w600,
                color: CkColors.ink2),
            CmFigureCell('${line.sixes}',
                width: 20, size: 11, weight: FontWeight.w600,
                color: CkColors.ink2),
            CmFigureCell(line.strikeRate.toStringAsFixed(1),
                width: 40, size: 11, weight: FontWeight.w600,
                color: CkColors.ink2),
          ],
        ),
      );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          CmFigureCell(line.oversLabel,
              width: 34, size: 11, weight: FontWeight.w600,
              color: CkColors.ink2),
          CmFigureCell('${line.maidens}',
              width: 20, size: 11, weight: FontWeight.w600,
              color: CkColors.ink2),
          CmFigureCell('${line.runs}',
              width: 26, size: 11, weight: FontWeight.w600,
              color: CkColors.ink2),
          CmFigureCell('${line.wickets}', width: 20),
          CmFigureCell(line.economy.toStringAsFixed(2),
              width: 40, size: 11, weight: FontWeight.w600,
              color: CkColors.ink2),
        ],
      ),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text('${card.totalRuns}/${card.wickets}',
  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          ...
          Text(
            names.join(', '),
            style: CkType.body(
                fontSize: 12.5, height: 1.5, color: CkColors.ink2),
          ),
        ],
      );
}
      ...
      children: [
        for (final (i, p) in card.partnerships.indexed)
          Container(
            ...
            decoration: BoxDecoration(
              border: i == card.partnerships.length - 1
                  ? null
                  : const Border(
                      bottom: BorderSide(color: CkColors.hairline)),
            ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    SizedBox(
                      width: 22,
                      child: Text(_ordinal(p.wicketNumber),
                          style: CmText.figure(
                              size: 10,
