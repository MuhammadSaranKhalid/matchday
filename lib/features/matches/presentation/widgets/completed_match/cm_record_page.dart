  ...
  Widget build(BuildContext context) => ListView(
    ...
    children: [
      ...
      if (view.absenceNote != null) ...[
        ...
        Text(
          view.absenceNote!,
          style: CkType.body(fontSize: 13.5, height: 1.6, color: CkColors.ink2),
        ),
      ],
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(r.value, style: CmText.name(size: 13)),
                    ),
                  ],
                ),
              ),
