...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,chatId,type,teamId,teamName,teamLogoUrl,teamLogoMonogram,teamPrimaryColor,dmOtherUserId,dmOtherUserName,dmOtherUserUsername,dmOtherUserAvatarUrl,youFollow,theyFollowYou,isAccepted,lastMessageAt,lastMessageBody,lastMessageSenderId,lastMessageFromMe,unreadCount,createdAt,updatedAt]);

@override
String toString() {
  return 'ChatDto(chatId: $chatId, type: $type, teamId: $teamId, teamName: $teamName, teamLogoUrl: $teamLogoUrl, teamLogoMonogram: $teamLogoMonogram, teamPrimaryColor: $teamPrimaryColor, dmOtherUserId: $dmOtherUserId, dmOtherUserName: $dmOtherUserName, dmOtherUserUsername: $dmOtherUserUsername, dmOtherUserAvatarUrl: $dmOtherUserAvatarUrl, youFollow: $youFollow, theyFollowYou: $theyFollowYou, isAccepted: $isAccepted, lastMessageAt: $lastMessageAt, lastMessageBody: $lastMessageBody, lastMessageSenderId: $lastMessageSenderId, lastMessageFromMe: $lastMessageFromMe, unreadCount: $unreadCount, createdAt: $createdAt, updatedAt: $updatedAt)';
}
