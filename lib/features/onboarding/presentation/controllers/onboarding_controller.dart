  ...
  Future<void> selectCitySuggestion(PlaceSuggestion suggestion) async {
    ...
    result.fold(
      ...
      (place) => _setProfile((p) => p.copyWith(
            city: place.city ??
                (place.label.isEmpty ? suggestion.fullText : place.label),
            label: place.label.isEmpty ? suggestion.fullText : place.label,
      ...
      (place) => _set(
        cur.copyWith(
          profile: cur.profile.copyWith(
            resolvingLocation: false,
            city: place.city ??
                (place.label.isEmpty ? cur.profile.city : place.label),
            label: place.label.isEmpty ? cur.profile.city : place.label,
            district: place.district,
            province: place.province,
            postcode: place.postcode,
            placeId: place.placeId,
