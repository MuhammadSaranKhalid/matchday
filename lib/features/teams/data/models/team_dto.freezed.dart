...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,teamId,ownerId,teamName,teamType,description,homeGround,const DeepCollectionEquality().hash(location),foundedYear,const DeepCollectionEquality().hash(teamColors),const DeepCollectionEquality().hash(managers),privacy,tagline,logoUrl,logoMonogram,createdAt,updatedAt);
...
switch (_that) {
case _TeamDto() when $default != null:
return $default(_that.teamId,_that.ownerId,_that.teamName,_that.teamType,_that.description,_that.homeGround,_that.location,_that.foundedYear,_that.teamColors,_that.managers,_that.privacy,_that.tagline,_that.logoUrl,_that.logoMonogram,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,teamId,ownerId,teamName,teamType,description,homeGround,const DeepCollectionEquality().hash(_location),foundedYear,const DeepCollectionEquality().hash(_teamColors),const DeepCollectionEquality().hash(_managers),privacy,tagline,logoUrl,logoMonogram,createdAt,updatedAt);
