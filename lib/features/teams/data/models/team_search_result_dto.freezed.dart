...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TeamSearchResultDto&&(identical(other.teamId, teamId) || other.teamId == teamId)&&(identical(other.teamName, teamName) || other.teamName == teamName)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.logoMonogram, logoMonogram) || other.logoMonogram == logoMonogram)&&const DeepCollectionEquality().equals(other.teamColors, teamColors)&&(identical(other.isVerified, isVerified) || other.isVerified == isVerified)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm)&&(identical(other.foundedYear, foundedYear) || other.foundedYear == foundedYear)&&(identical(other.teamType, teamType) || other.teamType == teamType)&&(identical(other.score, score) || other.score == score));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,teamId,teamName,logoUrl,logoMonogram,const DeepCollectionEquality().hash(teamColors),isVerified,distanceKm,foundedYear,teamType,score);

@override
String toString() {
  return 'TeamSearchResultDto(teamId: $teamId, teamName: $teamName, logoUrl: $logoUrl, logoMonogram: $logoMonogram, teamColors: $teamColors, isVerified: $isVerified, distanceKm: $distanceKm, foundedYear: $foundedYear, teamType: $teamType, score: $score)';
}
...
@useResult
$Res call({
@JsonKey(name: 'team_id') String teamId,@JsonKey(name: 'team_name') String teamName,@JsonKey(name: 'logo_url') String? logoUrl,@JsonKey(name: 'logo_monogram') String? logoMonogram,@JsonKey(name: 'team_colors') Map<String, dynamic>? teamColors,@JsonKey(name: 'is_verified') bool isVerified,@JsonKey(name: 'distance_km') double? distanceKm,@JsonKey(name: 'founded_year') int? foundedYear,@JsonKey(name: 'team_type') String? teamType, double score
});
...
/// Create a copy of TeamSearchResultDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? teamId = null,Object? teamName = null,Object? logoUrl = freezed,Object? logoMonogram = freezed,Object? teamColors = freezed,Object? isVerified = null,Object? distanceKm = freezed,Object? foundedYear = freezed,Object? teamType = freezed,Object? score = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'team_id')  String teamId, @JsonKey(name: 'team_name')  String teamName, @JsonKey(name: 'logo_url')  String? logoUrl, @JsonKey(name: 'logo_monogram')  String? logoMonogram, @JsonKey(name: 'team_colors')  Map<String, dynamic>? teamColors, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'distance_km')  double? distanceKm, @JsonKey(name: 'founded_year')  int? foundedYear, @JsonKey(name: 'team_type')  String? teamType,  double score)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TeamSearchResultDto() when $default != null:
return $default(_that.teamId,_that.teamName,_that.logoUrl,_that.logoMonogram,_that.teamColors,_that.isVerified,_that.distanceKm,_that.foundedYear,_that.teamType,_that.score);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'team_id')  String teamId, @JsonKey(name: 'team_name')  String teamName, @JsonKey(name: 'logo_url')  String? logoUrl, @JsonKey(name: 'logo_monogram')  String? logoMonogram, @JsonKey(name: 'team_colors')  Map<String, dynamic>? teamColors, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'distance_km')  double? distanceKm, @JsonKey(name: 'founded_year')  int? foundedYear, @JsonKey(name: 'team_type')  String? teamType,  double score)  $default,) {final _that = this;
switch (_that) {
case _TeamSearchResultDto():
return $default(_that.teamId,_that.teamName,_that.logoUrl,_that.logoMonogram,_that.teamColors,_that.isVerified,_that.distanceKm,_that.foundedYear,_that.teamType,_that.score);case _:
  throw StateError('Unexpected subclass');
...
class _TeamSearchResultDto extends TeamSearchResultDto {
  const _TeamSearchResultDto({@JsonKey(name: 'team_id') required this.teamId, @JsonKey(name: 'team_name') required this.teamName, @JsonKey(name: 'logo_url') this.logoUrl, @JsonKey(name: 'logo_monogram') this.logoMonogram, @JsonKey(name: 'team_colors') final  Map<String, dynamic>? teamColors, @JsonKey(name: 'is_verified') this.isVerified = false, @JsonKey(name: 'distance_km') this.distanceKm, @JsonKey(name: 'founded_year') this.foundedYear, @JsonKey(name: 'team_type') this.teamType, this.score = 0.0}): _teamColors = teamColors,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TeamSearchResultDto&&(identical(other.teamId, teamId) || other.teamId == teamId)&&(identical(other.teamName, teamName) || other.teamName == teamName)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.logoMonogram, logoMonogram) || other.logoMonogram == logoMonogram)&&const DeepCollectionEquality().equals(other._teamColors, _teamColors)&&(identical(other.isVerified, isVerified) || other.isVerified == isVerified)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm)&&(identical(other.foundedYear, foundedYear) || other.foundedYear == foundedYear)&&(identical(other.teamType, teamType) || other.teamType == teamType)&&(identical(other.score, score) || other.score == score));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,teamId,teamName,logoUrl,logoMonogram,const DeepCollectionEquality().hash(_teamColors),isVerified,distanceKm,foundedYear,teamType,score);
...
/// Create a copy of TeamSearchResultDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? teamId = null,Object? teamName = null,Object? logoUrl = freezed,Object? logoMonogram = freezed,Object? teamColors = freezed,Object? isVerified = null,Object? distanceKm = freezed,Object? foundedYear = freezed,Object? teamType = freezed,Object? score = null,}) {
