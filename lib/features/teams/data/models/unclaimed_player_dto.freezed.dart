...
@JsonKey(name: 'unclaimed_id') String get unclaimedId;@JsonKey(name: 'display_name') String get displayName;// Nullable: the manager who created the placeholder may since have
// deleted their account (FK is ON DELETE SET NULL), and delete_user's
// synthetic placeholder has no creator at all.
@JsonKey(name: 'added_by') String? get addedBy;// Never present on a normal read — revoked at column level. Populated only
// by unclaimed_player_contact_for_manager().
@JsonKey(name: 'phone_number') String? get phoneNumber;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;@JsonKey(name: 'player_profile') Map<String, dynamic> get playerProfile;
...
/// Create a copy of UnclaimedPlayerDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? unclaimedId = null,Object? displayName = null,Object? addedBy = freezed,Object? phoneNumber = freezed,Object? createdAt = null,Object? updatedAt = null,Object? playerProfile = null,}) {
...
/// Create a copy of UnclaimedPlayerDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? unclaimedId = null,Object? displayName = null,Object? addedBy = freezed,Object? phoneNumber = freezed,Object? createdAt = null,Object? updatedAt = null,Object? playerProfile = null,}) {
