...
class _TeamCreateState extends TeamCreateState {
  const _TeamCreateState({this.step = TeamCreateStep.basics, this.name = '', this.type = TeamType.club, this.privacy = TeamPrivacy.public, this.tagline = '', this.foundedYear, this.homeGround = '', this.primaryColor = '#338946', this.secondaryColor = '#FDFAF4', this.crestKind = CrestKind.monogram, this.monogramOverride, this.logoUrl, this.logoName, this.logoSize, this.submitting = false, this.submitError, this.logoUploadError, this.createdTeamId}): super._();
