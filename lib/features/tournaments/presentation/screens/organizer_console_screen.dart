...
class _OrganizerConsoleScreenState
  ...
  /// After the draw locks the tabs become "Teams / Fixtures" (artboard 25d):
  /// nobody is applying any more, so the first tab is a roster, not a queue.
  String _peopleTabLabel(Tournament t) =>
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(
                  child: _TabLabel(
                    label: _peopleTabLabel(tournament),
