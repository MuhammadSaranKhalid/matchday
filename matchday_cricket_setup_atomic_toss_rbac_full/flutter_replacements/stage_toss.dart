...
class MatchStartTossStage extends ConsumerWidget {
  ...
  Widget build(
    ...
    final winner =
        state.pendingTossWinner;

    final decision =
        state.pendingDecision;

    final batting =
        state.pendingBattingTeamId;
...
/// records in the form.
class MatchStartCoinTile
    extends StatefulWidget {
  const MatchStartCoinTile({
    super.key,
    this.face,
  });
  ...
  @override
  State<MatchStartCoinTile>
      createState() =>
          _MatchStartCoinTileState();
}

class _MatchStartCoinTileState
    extends State<MatchStartCoinTile>
    with SingleTickerProviderStateMixin {
  static const _spinDuration =
      Duration(
    milliseconds: 1300,
  );

  static const _faceSwapInterval =
      Duration(
    milliseconds: 110,
  );
