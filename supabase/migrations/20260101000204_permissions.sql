-- Migration file: 20260101000204_permissions.sql
...
insert into public.permissions(permission_key, resource, action, description, min_rank, direct_grantable, sort_order)
values
