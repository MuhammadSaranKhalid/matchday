-- =============================================================================
-- Migration: 20260101000206_role_permissions.sql
-- =============================================================================
...
create index idx_role_permissions_team
  on public.role_permissions (team_id);
...
begin
  ...
  if v_rank < v_min then
    raise exception 'Permission % requires rank >= %; role % has rank %',
      new.permission_key,
      v_min,
      new.role_key,
      v_rank
