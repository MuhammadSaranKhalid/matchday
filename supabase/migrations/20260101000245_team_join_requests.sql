-- =============================================================================
-- Migration: 20260101000245_team_join_requests.sql
-- =============================================================================
...
create table public.team_join_requests (
  ...
  constraint join_request_decision_consistency
    check (
...
create index team_join_requests_team
  on public.team_join_requests (team_id);

create index team_join_requests_player
...
create policy team_join_requests_read
  on public.team_join_requests
  for select
  to authenticated
  using (
...
grant execute
on function public.accept_team_join_request(uuid, integer)
to authenticated;
...
grant execute
on function public.request_to_join_team(uuid, text, text)
to authenticated;
