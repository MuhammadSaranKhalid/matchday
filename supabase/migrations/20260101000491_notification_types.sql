...
create table public.notification_types (
  ...
  queue_name            text not null default 'notifications_push'
                          check (queue_name in ('notifications_push',
  ...
  default_channels      text[] not null default '{inapp,push}'
                          check (default_channels <@ array['inapp', 'push']),
  ...
  constraint notification_types_collapse_coherent
    check (
      (collapse_template is null and collapse_window is null
        and body_template_grouped is null)
      or (collapse_template is not null and collapse_window is not null and collapse_window > interval '0 seconds')
    )
);
...
insert into public.notification_types (
  key, category, title_template, body_template, body_template_grouped,
  route_template, icon, tier, importance, queue_name,
  collapse_template, collapse_window
) values

-- ── match ───────────────────────────────────────────────────────────────────
('match.challenge.received', 'match',
 '{{opponent_name}} challenged you',
 'Tap to accept, counter or decline', null,
 '/challenges/{{request_id}}', 'bat', 'now', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.challenge.accepted', 'match',
 'Challenge accepted',
 '{{opponent_name}} accepted your match', null,
 '/challenges/{{request_id}}', 'check', 'now', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.challenge.declined', 'match',
 'Challenge declined',
 '{{opponent_name}} declined your challenge', null,
 '/challenges/{{request_id}}', 'x', 'week', 'normal', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.challenge.countered', 'match',
 'Counter-offer',
 '{{opponent_name}} proposed new terms — tap to review', null,
 '/challenges/{{request_id}}', 'bat', 'now', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.challenge.cancelled', 'match',
 'Match cancelled',
 'Your match against {{opponent_name}} was cancelled', null,
 '/challenges/{{request_id}}', 'x', 'week', 'normal', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.challenge.expired', 'match',
 'Challenge expired',
 'Your challenge expired with no reply', null,
 '/challenges/{{request_id}}', 'x', 'week', 'low', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.starting', 'match',
 'Your match is starting',
 '{{team_name}} vs {{opponent_name}} is about to begin', null,
 '/matches/{{match_id}}', 'bat', 'now', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('match.upcoming', 'match',
 'Match coming up',
 '{{team_name}} vs {{opponent_name}} is scheduled soon', null,
 '/matches/{{match_id}}', 'calendar', 'week', 'normal', 'notifications_push',
 null, null),
...
('match.scorer.assigned', 'match',
 'You are scoring this match',
 'You were assigned as scorer for {{team_name}} vs {{opponent_name}}', null,
 '/matches/{{match_id}}', 'bat', 'now', 'high', 'notifications_push',
 null, null),
...
('match.application.received', 'match',
 '{{opponent_name}} applied to your open match',
 'Tap to review and pick your opponent',
 '{{count}} teams applied to your open match',
 '/challenges/{{request_id}}', 'bat', 'now', 'high', 'notifications_push',
 'match.application:{{request_id}}', interval '12 hours'),        -- ← PORTED

('match.application.accepted', 'match',
 'You got the match',
 '{{opponent_name}} accepted your application', null,
 '/matches/{{match_id}}', 'check', 'now', 'high', 'notifications_push',
 null, null),                                                     -- ← PORTED

('match.official.assigned', 'match',
 'You have been appointed',
 'You were appointed {{role_name}} for an upcoming match', null,
 '/matches/{{match_id}}', 'shield', 'week', 'normal', 'notifications_push',
 null, null),

('match.completed', 'match',
 'Result is in',
 '{{team_name}} vs {{opponent_name}} has finished', null,
 '/matches/{{match_id}}/summary', 'trophy', 'fyi', 'low', 'notifications_push',
 null, null),

-- ── team ────────────────────────────────────────────────────────────────────
('team.invitation.received', 'team',
 'You were invited to a team',
 '{{actor_name}} invited you to join {{team_name}}', null,
 '/teams/{{team_id}}', 'group', 'week', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('team.join.requested', 'team',
 'New join request',
 '{{actor_name}} wants to join {{team_name}}',
 '{{count}} people want to join {{team_name}}',
 '/teams/{{team_id}}/manage', 'person_add', 'now', 'normal',
 'notifications_push',
 'team.join.requested:{{team_id}}', interval '24 hours'),

('team.join.approved', 'team',
 'You are in',
 '{{team_name}} accepted your request to join', null,
 '/teams/{{team_id}}', 'check', 'week', 'high', 'notifications_push',
 null, null),

('team.join.declined', 'team',
 'Request declined',
 '{{team_name}} declined your request to join', null,
 '/teams', 'x', 'week', 'normal', 'notifications_push',
 null, null),

('team.role.granted', 'team',
 'New role',
 'You are now {{role_name}} of {{team_name}}', null,
 '/teams/{{team_id}}', 'shield', 'week', 'high', 'notifications_push',
 null, null),

('team.claim.approved', 'team',
 'Claim approved',
 'Your claim on a player profile in {{team_name}} was approved', null,
 '/teams/{{team_id}}', 'check', 'now', 'high', 'notifications_push',
 null, null),                                                    -- ← PORTED

('team.claim.declined', 'team',
 'Claim declined',
 'Your claim on a player profile in {{team_name}} was declined', null,
 '/teams/{{team_id}}', 'x', 'now', 'normal', 'notifications_push',
 null, null),                                                    -- ← PORTED
...
('team.post.published', 'team',
 'New team post',
 '{{team_name}} posted an update', null,
 null, 'group', 'fyi', 'low', 'notifications_push_bulk',
 null, null),

-- ── tournament ──────────────────────────────────────────────────────────────
('tournament.registration.requested', 'tournament',
 'New registration',
 '{{team_name}} registered for {{tournament_name}}',
 '{{count}} teams registered for {{tournament_name}}',
 '/tournaments/{{tournament_id}}/requests', 'trophy', 'now', 'normal',
 'notifications_push',
 'tournament.registration:{{tournament_id}}', interval '12 hours'),

('tournament.registration.approved', 'tournament',
 'You are in the draw',
 '{{team_name}} was accepted into {{tournament_name}}', null,
 '/tournaments/{{tournament_id}}/register/status', 'check', 'week', 'high',
 'notifications_push', null, null),

('tournament.registration.declined', 'tournament',
 'Registration declined',
 '{{tournament_name}} declined {{team_name}}', null,
 '/tournaments/{{tournament_id}}/register/status', 'x', 'week', 'normal',
 'notifications_push', null, null),
...
('tournament.organizer.added', 'tournament',
 'You are now an organizer',
 'You were added as an organizer of {{tournament_name}}', null,
 '/tournaments/{{tournament_id}}/console', 'shield', 'now', 'high',
 'notifications_push', null, null),                               -- ← PORTED

('tournament.fixture.published', 'tournament',
 'Fixtures are out',
 'The draw for {{tournament_name}} has been published', null,
 '/tournaments/{{tournament_id}}', 'calendar', 'week', 'normal',
 'notifications_push_bulk', null, null),

('tournament.post.published', 'tournament',
 'Tournament update',
 '{{tournament_name}} posted an announcement', null,
 '/tournaments/{{tournament_id}}', 'trophy', 'fyi', 'low',
 'notifications_push_bulk', null, null),                         -- ← PORTED
...
('chat.message.received', 'chat',
 ...
 '{{count}} new messages',
 '/messages/{{chat_id}}', 'message', 'now', 'high', 'notifications_push',
 'chat.message:{{chat_id}}', interval '1 hour'),

('chat.request.received', 'chat',
 'Message request',
 '{{actor_name}} wants to message you', null,
 '/messages', 'message', 'now', 'normal', 'notifications_push',
 null, null),
...
('social.follow', 'social',
 ...
 '/u/{{actor_username}}', 'person_add', 'fyi', 'low', 'notifications_push',
 'social.follow', interval '24 hours'),                          -- ← PORTED
...
('social.post.liked', 'social',
 'New like',
 '{{actor_name}} liked your post',
 '{{count}} people liked your post',
 null, 'heart', 'fyi', 'low', 'notifications_push',
 'social.post.liked:{{post_id}}', interval '24 hours'),          -- ← PORTED

('social.post.commented', 'social',
 'New comment',
 '{{actor_name}} commented on your post',
 '{{count}} people commented on your post',
 null, 'comment', 'week', 'normal', 'notifications_push',
 'social.post.commented:{{post_id}}', interval '12 hours'),      -- ← PORTED

('social.comment.replied', 'social',
 'New reply',
 '{{actor_name}} replied to your comment', null,
 null, 'comment', 'week', 'normal', 'notifications_push',
 null, null),                                                    -- ← PORTED

('social.mention', 'social',
 'You were mentioned',
 '{{actor_name}} mentioned you', null,
 null, 'at', 'week', 'normal', 'notifications_push',
 null, null),                                                    -- ← PORTED

-- ── system ──────────────────────────────────────────────────────────────────
('system.stat.milestone', 'system',
 'Career milestone',
 '{{milestone_text}}', null,
 '/profile', 'star', 'fyi', 'low', 'notifications_push',
 null, null);
...
update public.notification_types set tone = case
