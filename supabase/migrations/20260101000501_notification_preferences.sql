...
create table public.notification_preferences (
  ...
  category  text not null
                 references public.notification_categories(key) on delete cascade,
...
create index notification_preferences_category
  on public.notification_preferences (category);
