...
create table public.posts (
  ...
  media                jsonb not null default '[]'::jsonb constraint posts_media_shape
...
create index posts_linked_team
  on public.posts (linked_team_id)
...
revoke all
on function public.can_act_for_post_context(public.post_author_context, uuid)
from public;
