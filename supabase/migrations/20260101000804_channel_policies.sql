-- Migration file: 20260101000804_channel_policies.sql
...
create table public.channel_policies(
  ...
  constraint channel_policy_lengths check (max_message_length between 1 and 20000 and slow_mode_seconds between 0 and 86400)
);

-- Section: Triggers

create trigger channel_policies_set_updated_at
  before update on public.channel_policies for each row
