-- Migration file: 20260101000806_messages.sql
...
create unique index messages_channel_seq_unique on public.messages(channel_id, message_seq);

create index messages_channel_page_idx on public.messages(channel_id, message_seq desc);
