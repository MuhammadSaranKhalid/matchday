-- Migration file: 20260101000813_chat_media_storage.sql
...
insert into storage.buckets(id, name, public, file_size_limit, allowed_mime_types)
  values ('chat-media', 'chat-media', false, 52428800, -- 50 MB
    array['image/jpeg', 'image/png', 'image/webp', 'image/gif', 'video/mp4', 'video/quicktime', 'audio/mpeg', 'audio/mp4', 'audio/wav', 'audio/aac', 'application/pdf'])
on conflict (id)
  do update set
    public = false,
    file_size_limit = 52428800,
    allowed_mime_types = array['image/jpeg', 'image/png', 'image/webp', 'image/gif', 'video/mp4', 'video/quicktime', 'audio/mpeg', 'audio/mp4', 'audio/wav', 'audio/aac', 'application/pdf'];

-- Section: Policies

-- Storage RLS: Channel members can read attachments in channels they belong to
create policy "chat_media_read_policy" on storage.objects
