-- =============================================================================
-- Migration: 20260926184000_fix_build_post_projections_publisher_names.sql
-- =============================================================================
-- Fixes column references in private.build_post_projections:
-- teams table column is team_name, not name.
-- tournaments table column is tournament_name, not name.
-- Output publisher json object now includes both display_name and name.
-- =============================================================================
