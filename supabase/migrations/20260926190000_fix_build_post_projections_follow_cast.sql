-- =============================================================================
-- Migration: 20260926190000_fix_build_post_projections_follow_cast.sql
-- =============================================================================
-- Fixes enum comparison in private.build_post_projections:
-- post_publisher_type cannot be directly cast to follow_target_type without text.
-- Use text comparison: f.target_type::text = p.publisher_type::text, and check f.status = 'active'.
-- =============================================================================
